    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Text("双指在边缘停留片刻，再上下滑动。上滑增大，下滑减小。")
                ...
                GeometryReader { geometry in
                    HStack(spacing: 0) {
                        ...
                        VStack(spacing: 8) {
                            Image(systemName: "hand.point.up.braille").font(.title2)
                ...
                Text("两根手指都从同一侧边缘开始，停留约 0.2 秒后滑动；抬手结束。中间区域、三指及以上操作、按下点击均不会调节。亮度优先控制内置屏幕，最低保留 5%；音量跟随当前系统输出设备。")
